...
public class IceCreamPlum extends Item{

	static int id = 95;
	static String name = "Plum Ice Cream";
	...
	static String descrShort="Restore Hp and buff Skl.";
	public IceCreamPlum() {
	...
	public void use(Schmuck perp, Schmuck vic, BattleState bs){
		...
		bs.bp.stm.addStatus(vic, new StatBuffMult(4, 5, 1.2, perp, vic, 50));
	}
	
	public String useName(Schmuck perp, Schmuck vic, BattleState bs){
		if(perp.getName().equals(vic.getName())){
			return vic.getName()+" eats a Plum Ice Cream!";
		}
		else{
			return perp.getName()+" gives "+vic.getName()+" a Plum Ice Cream!";
		}
	}
