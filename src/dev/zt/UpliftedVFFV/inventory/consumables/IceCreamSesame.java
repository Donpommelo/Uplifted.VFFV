...
public class IceCreamSesame extends Item{

	static int id = 95;
	static String name = "Sesame Ice Cream";
	...
	static String descrShort="Restore Hp and buff Luk.";
	public IceCreamSesame() {
	...
	public void use(Schmuck perp, Schmuck vic, BattleState bs){
		...
		bs.bp.stm.addStatus(vic, new StatBuffMult(4, 7, 1.2, perp, vic, 50));
	}
	
	public String useName(Schmuck perp, Schmuck vic, BattleState bs){
		if(perp.getName().equals(vic.getName())){
			return vic.getName()+" eats a Sesame Ice Cream!";
		}
		else{
			return perp.getName()+" gives "+vic.getName()+" a Sesame Ice Cream!";
		}
	}
