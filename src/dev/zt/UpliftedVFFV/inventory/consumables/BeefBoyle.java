...
public class BeefBoyle extends Item{
	...
	static String descr="A thick, stew filled containing several ingredients with varying liklihoods of being beef.";
	...
	public void use(Schmuck perp, Schmuck vic, BattleState bs){
		...
		bs.bp.stm.addStatus(perp, new Silenced(5, perp, perp, 30));
	}
