...
public class RandomFoodMedium extends Item{
	...
	static int slot = 0;
	static int lvlReq = 1;
	static String descr="A medium amount of some bizarre and randomly generated foodstuffs.";
	static String descrShort="Restores a lot of Hp.";
	public RandomFoodMedium() {
		...
		super.setName(item0+item1+item2);
	
	}
		
	public void use(Schmuck perp, Schmuck vic, BattleState bs){
		bs.bp.em.hpChange((int)(150*(1+perp.getItemPow())*(1+vic.getRegenBonus())),perp,vic,6);
		bs.bp.em.bpChange((int)(100*(1+perp.getItemPow())*(1+vic.getRegenBonus())),vic);
	...
	public void use(Schmuck s,Game game, StateManager sm,GameState gs){
		s.hpChange((int)(150*(1+s.getItemPow())*(1+s.getRegenBonus())));
		s.bpChange((int)(100*(1+s.getItemPow())*(1+s.getRegenBonus())));
