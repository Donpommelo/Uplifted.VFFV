...
public class CarrotJuice extends Item{
	...
	static int slot = 0;
	static int lvlReq = 2;
	static String descr="A can of fizzy, orange liquid. It can serve as a nutritious substitute to soda, if you didn't really want to drink a soda to begin with.";
	...
	public void use(Schmuck perp, Schmuck vic, BattleState bs){
		...
		bs.bp.stm.addStatus(vic, new BonusStatBuff(5,0,.25, perp,vic,75));
	}
