...
public class HiveRhythmB extends Item{
	...
	static int slot = 1;
	static int lvlReq = 1;
	static String descr="A soothing and calming note, echoing endlessly in\nthe head if its wielder.";
	...
	public status[] getEnchantment(Schmuck s) {
		enchantment[0] = new ElemPointsBuff(1, (int)(10*(1+s.getEquipPow())), 50);
		enchantment[1] = new HiveRhythmBuffStatus(50);
		enchantment[2] = new HiveRhythmItemBStatus(50, enchantment[1]);
		return enchantment;
	}
