...
import dev.zt.UpliftedVFFV.statusEffects.EquipmentStatus.HiveRhythmItemCStatus;
import dev.zt.UpliftedVFFV.statusEffects.Stats.ElemPointsBuff;

public class HiveRhythmC extends Item{

	static int id = 2;
	static String name = "Hive Rhythm: C";
	...
	static int slot = 1;
	static int lvlReq = 1;
	static String descr="A reverent and inspiring note, echoing endlessly in the head if its wielder.";
	static String descrShort = "+10 Green Points\nMakes you one with the Hive";
	...
	public status[] getEnchantment(Schmuck s) {
		enchantment[0] = new ElemPointsBuff(2, (int)(10*(1+s.getEquipPow())), 50);
		enchantment[1] = new HiveRhythmBuffStatus(50);
		enchantment[2] = new HiveRhythmItemCStatus(50, enchantment[1]);
		return enchantment;
	}
