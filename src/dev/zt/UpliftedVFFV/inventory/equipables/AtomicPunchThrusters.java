...
public class AtomicPunchThrusters extends Item{
	...
	static String descr="A bulky pair of gloves that harness the power of splitting atoms\nto punch and irradiate foes.";
	...
	public status[] getEnchantment(Schmuck s) {
		enchantment[0] = new ExplosiveCrit((int)(s.getBuffedPow()*(1+s.getEquipPow())), 75);
		enchantment[1] = new BonusStatBuff(16,.15*(1+s.getEquipPow()), 75);
		return enchantment;
	}
