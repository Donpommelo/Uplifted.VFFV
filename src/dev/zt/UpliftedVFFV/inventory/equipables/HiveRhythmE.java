...
import dev.zt.UpliftedVFFV.statusEffects.EquipmentStatus.HiveRhythmItemEStatus;
...
public class HiveRhythmE extends Item{
	...
	static int slot = 1;
	static int lvlReq = 1;
	static String descr="A complex and confusing note, echoing endlessly in the head if its wielder.";
	...
	public status[] getEnchantment(Schmuck s) {
		enchantment[0] = new ElemPointsBuff(4,(int)(10*(1+s.getEquipPow())),s, 50);
		enchantment[1] = new HiveRhythmBuffStatus(s,50);
		enchantment[2] = new HiveRhythmItemEStatus(s,50, enchantment[1]);
		return enchantment;
	}
