		...
		case 0:
			...
			for(Schmuck ally : bs.bp.getSelectableAllies(a.getUser())){
				if(bs.bp.stm.checkStatus(ally, new HiveRhythmBuffStatus(50))){
					bs.bp.stm.addStatus(ally, new BonusStatBuff(0, 10, 0.5, a.getUser(), 50));
				}
			}
			break;
		case 1:
			...
			for(Schmuck ally : bs.bp.getSelectableAllies(a.getUser())){
				if(bs.bp.stm.checkStatus(ally, new HiveRhythmBuffStatus(50))){
					bs.bp.stm.addStatus(ally, new Vampirism(0, 0.25, a.getUser(), 50));
				}
			}
			break;
		case 3:
			...
			for(Schmuck enemy : bs.bp.getSelectableEnemies(a.getUser())){
				bs.bp.stm.addStatus(enemy, new Poisoned(2,a.getUser(), 50));
			}
			break;
		case 4:
			...
			for(Schmuck ally : bs.bp.getSelectableAllies(a.getUser())){
				if(bs.bp.stm.checkStatus(ally, new HiveRhythmBuffStatus(50))){
					bs.bp.stm.addStatus(ally, new StatBuffMult(3, 5, 1.1, a.getUser(), 50));
				}
			}
			break;
		}
