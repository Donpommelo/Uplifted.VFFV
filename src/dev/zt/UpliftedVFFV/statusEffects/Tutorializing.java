...
public class Tutorializing extends status{
	...
	public Tutorializing(Schmuck v,int pr){
		super(name, v,pr);
	}
	...
	public void endofturnEffect(Schmuck s, BattleState bs){
		if(bs.bp.roundNum == 1){
			...
			d[8] = new Dialog("Pen Pal","/CharacterBusts/Player-5.png",0,"That, is precisely what the 'Wait' option allows you to do!");
			d[9] = new Dialog("Pen Pal","/CharacterBusts/Player-5.png",0,"When choosing to wait, a character will delay the decision-making process until his or her turn to act comes, when the action is decided and executed immediately.");
			d[10] = new Dialog("Pen Pal","/CharacterBusts/Player-5.png",0,"Bear in mind that Waiting will make you lose some initiative. Wait too much and you may miss a golden opportunity!");
			d[11] = new Dialog("Pen Pal","/CharacterBusts/Player-5.png",0,"Finally, there is the 'Run' action. This allows you to attempt to flee from combat./No one will judge you for selecting this option.");
			d[12] = new Dialog("Pen Pal","/CharacterBusts/Player-5.png",0,"That just about does it! Now, lets finish this and continue our quest.");
			DialogState firstfite = new DialogState(bs.getGame(),bs.gs,bs.gs.getStateManager(),d ,12,0,true);
	...
	public void endoffightEffect(Schmuck s, Boolean won, BattleState bs){
		...
		d[3] = new Dialog("Pen Pal", "/CharacterBusts/Player-5.png",0,"Combat also provides to its participants valuable Work Experience. Gain enough Exp to level up and climb the corporate ladder.");
		d[4] = new Dialog("Pen Pal", "/CharacterBusts/Player-5.png",0,"Become a more valuable company asset and gain more transferable job skills!");
		d[5] = new Dialog("Pen Pal", "/CharacterBusts/Player-5.png",0,"Lastly, enemies will sometimes drop valuable loot! These items can be examined closely in your inventory, viewable from the menu! ('Z')");

		DialogState firstfite = new DialogState(bs.getGame(),bs.gs,bs.gs.getStateManager(),d ,5,0,true);
		StateManager.getStates().push(firstfite);
