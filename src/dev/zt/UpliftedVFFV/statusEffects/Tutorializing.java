...
public class Tutorializing extends status{
	...
	public void startoffightEffect(Schmuck s, BattleState bs){//
		...
		d[6] = new Dialog("Pen Pal","/CharacterBusts/Player-5.png",0,"You can keep track of the inevitable chaos in the battle text screen./That can be found right over . . ./Hmm. Where was it? I just saw it . . .");
		d[7] = new Dialog("Pen Pal","/CharacterBusts/Player-5.png",0,". . ./ Ah, yes! Right over . . .");
