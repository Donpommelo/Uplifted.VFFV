...
public class Floater extends Schmuck{

//	private static final long serialVersionUID = -7556561902401868149L;
	
	public final static int startHp=111,startBp=50,startPow=47, startDef=48, startSpd=64, startSkl=50, startLuk=33, startInt=15;
	public final static int[] startStats = {startHp,startBp,startPow,startDef,startSpd,startSkl,startInt,startLuk};
	public final static double hpGrowth=21.3, bpGrowth=16.7, powGrowth=3.7, defGrowth=2.2, spdGrowth=3.7, sklGrowth=1.9, intGrowth=4.1, lukGrowth=.9;
	...
	public static String name = "Floater";
	public static String plural = "Floaters";
	public static String pronoun = "it";
	
	public static int sprite = 20;
	...
	public final static String bioShort = "";
	public final static String bioLong = "";
	
	public Floater(int level) {
	...
	public Action getAction(BattleState bs){
		...
		if(bs.bs.alliesTargets.isEmpty()){
			...
			case 0:
				...
				break;
			case 1:
				act = new Action(this,bs.bs.alliesTargets.get((int)(Math.random()*bs.bs.alliesTargets.size())),new DamnedDescent(0),bs);
				break;
			case 2:
				act = new Action(this,bs.bs.alliesTargets.get((int)(Math.random()*bs.bs.alliesTargets.size())),new CrushCables(0),bs);
				break;
			}
		}	
		return act;
