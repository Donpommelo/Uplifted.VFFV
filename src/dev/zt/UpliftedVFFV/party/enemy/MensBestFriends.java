...
import dev.zt.UpliftedVFFV.ablities.BloodChillHowl;
import dev.zt.UpliftedVFFV.ablities.PassTurn;
import dev.zt.UpliftedVFFV.ablities.Skills;
import dev.zt.UpliftedVFFV.ablities.StandardAttack;
import dev.zt.UpliftedVFFV.ablities.TriStrike;
...
public class MensBestFriends extends Schmuck{

//	private static final long serialVersionUID = -7556561902401868149L;
	
	public final static int startHp=201,startBp=50,startPow=57, startDef=48, startSpd=35, startSkl=30, startLuk=53, startInt=85;
	...
	public static String name = "Men's Best Friends";
	public static String plural = "Men's Best Friends";
	public static String pronoun = "it";
	
	public static int sprite = 28;
	...
	public MensBestFriends(int level) {
	...
	public Action getAction(BattleState bs){
		...
		if(bs.bs.alliesTargets.isEmpty()){
			...
			switch (random){
			case 0:
				act = new Action(this,bs.bs.alliesTargets.get((int)(Math.random()*bs.bs.alliesTargets.size())),new TriStrike(0),bs);
				break;
			case 1:
				act = new Action(this,bs.bs.alliesTargets.get((int)(Math.random()*bs.bs.alliesTargets.size())),new BloodChillHowl(0),bs);
				break;
			}
		}	
		return act;
