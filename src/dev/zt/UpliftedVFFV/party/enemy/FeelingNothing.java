...
public class FeelingNothing extends Schmuck{
...
//	private static final long serialVersionUID = -7556561902401868149L;
	...
	public static String name = "Just a Feeling";
	public static String plural = "Just Some Feelings";
	public static String pronoun = "it";
	
	public static int sprite = 23;
	...
	public FeelingNothing(int level) {
