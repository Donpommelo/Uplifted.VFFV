...
public class PlatedGhost extends Schmuck{

//	private static final long serialVersionUID = -7556561902401868149L;
	
	public final static int startHp=175,startBp=50,startPow=42, startDef=64, startSpd=31, startSkl=42, startLuk=30, startInt=61;
	...
	public static String name = "Plated Ghost";
	public static String plural = "Plated Ghosts";
	public static String pronoun = "it";
	
	public static int sprite = 24;
