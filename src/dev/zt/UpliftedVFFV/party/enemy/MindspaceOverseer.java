...
public class MindspaceOverseer extends Schmuck{

//	private static final long serialVersionUID = -7556561902401868149L;
	
	public final static int startHp=201,startBp=50,startPow=67, startDef=68, startSpd=35, startSkl=60, startLuk=53, startInt=85;
	...
	public static String name = "Mindspace Overseer";
	public static String plural = "Mindspace Overseers";
	public static String pronoun = "it";
	
	public static int sprite = 31;
	...
	public MindspaceOverseer(int level) {
	...
	public Action getAction(BattleState bs){
		...
		if(bs.bs.alliesTargets.isEmpty()){
			...
			case 0:
				...
				break;
			case 1:
				act = new Action(this,bs.bs.alliesTargets.get((int)(Math.random()*bs.bs.alliesTargets.size())),new Oversight(0),bs);
				break;
			}
		}	
		return act;
