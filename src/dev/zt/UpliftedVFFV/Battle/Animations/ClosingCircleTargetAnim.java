...
public class ClosingCircleTargetAnim extends BattleAnimation{
	
	boolean ally;
	BattleState bs;
	static int frames = 50;
	int color;
	public ClosingCircleTargetAnim(int c){
		super(frames);
		this.color = c;
	}
	...
	public void animateAction(int frame, Action a, Graphics g){
		...
		g.drawOval(startx+frame*2-100, starty+frame*2-100, 200-frame*4, 200-frame*4);
	}
}
