...
public class WarpTanktoDungeon extends Event {

	public static BufferedImage img=Assets.ClearDoor1;

	public static int stagenum = 1;
	public WarpTanktoDungeon(float x, float y, int idnum) {
	...
	public void run(){
		...
		case 1:
			...
			case 0:
				super.transport("/Worlds/Floor4Aquarium/WetworksDungeon/CentralChamberNotCleared.txt",16,39,"The Wetworks");
				break;
			case 1:
				super.transport("/Worlds/Floor4Aquarium/WetworksDungeon/CentralChamberPartiallyCleared.txt",16,39,"The Wetworks");
				break;
			case 2:
				super.transport("/Worlds/Floor4Aquarium/WetworksDungeon/CentralChamberFullyCleared.txt",16,39,"The Wetworks");
				break;
