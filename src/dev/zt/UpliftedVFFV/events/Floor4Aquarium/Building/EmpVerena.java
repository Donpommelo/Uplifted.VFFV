...
public class EmpVerena extends Event {
	...
	public void run(){
		...
		d[0] = new Dialog("Employee","/CharacterBusts/3rdSouthOffices-3.png",1,"I think my desk is pretty much covered with Aquarium souvenirs by now.");
