...
public class EmpSlithrice extends Event {

	public static int stagenum = 1;
	public static BufferedImage img=SpriteSorter.SpriteSort(4,Assets.EmployeeF);
	public EmpSlithrice(float x, float y, int idnum) {
	...
	public void run(){
		...
		case 0: 
			...
			d[0] = new Dialog("Employee","/CharacterBusts/3rdSouthOffices-3.png",1,"This show had better be worth the wait.");
			d[1] = new Dialog("Employee","/CharacterBusts/3rdSouthOffices-3.png",1,"I personally consider my time here very valuable.");
