...
public class EmpFinn extends Event {
	...
	public void run(){
		...
		case 0: 
			...
			d[0] = new Dialog("Employee","/CharacterBusts/3rdSouthOffices-1.png",1,"Dolphins are pretty much seals with fins. And less facial hair.");
