...
public class WarpDeeperSeaDungeontoDeepest extends Event {

	public static BufferedImage img=Assets.ClearDoor1;

	public static int stagenum = 1;
	public WarpDeeperSeaDungeontoDeepest(float x, float y, int idnum) {
	...
	public void run(){
		...
		case 1:
			...
			this.setstage(0);
			super.transport("/Worlds/Floor4Aquarium/AquariumBuilding/DeepestSeaDungeon.txt",5,42,"");
			this.setOpen(false);
			this.setFrames(0);
			break;
		}
	...
	public void tick(GameState gs) {
		if(this.isOpen()){
			if(this.getFrames()<6){
				...
				if(KeyManager.isCutsceneMode() && gs.getPlayer().getPlayerX()== 544){
