...
public class EmpGlass extends Event {
	...
	public void run(){
		...
		case 0: 
			...
			d[0] = new Dialog("Employee","/CharacterBusts/3rdSouthOffices-1.png",1,"Hey, buddy! Don’t touch the glass! You’ll get your greasy smudges on it!/");
