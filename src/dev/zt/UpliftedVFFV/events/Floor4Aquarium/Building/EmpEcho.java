...
public class EmpEcho extends Event {
	...
	public void run(){
		...
		case 0: 
			...
			d[0] = new Dialog("Employee","/CharacterBusts/3rdSouthOffices-3.png",1,"Dolphins navigate using echolocation, a necessary adaptation due to their illiteracy.");
