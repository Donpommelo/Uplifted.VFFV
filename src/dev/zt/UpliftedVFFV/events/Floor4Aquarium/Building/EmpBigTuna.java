...
public class EmpBigTuna extends Event {
	
	public static int stagenum = 1;
	public static BufferedImage img=SpriteSorter.SpriteSort(4,Assets.EmployeeM1);
	public EmpBigTuna(float x, float y, int idnum) {
	...
	public void run(){
		...
		case 0: 
			...
			d[0] = new Dialog("Employee","/CharacterBusts/3rdSouthOffices-1.png",1,"The Dolphin performance seems to be delayed. I guess that means a longer break for me.");
