...
public class EmpWaldorf extends Event {
	
	public static int stagenum = 1;
	public static BufferedImage img=SpriteSorter.SpriteSort(1,Assets.EmployeeM1);
	public EmpWaldorf(float x, float y, int idnum) {
	...
	public void run(){
		...
		case 0: 
			...
			d[0] = new Dialog("Employee","/CharacterBusts/3rdSouthOffices-1.png",1,"Hey, which fish is your favorite?/");
			d[1] = new Dialog("Employee","/CharacterBusts/3rdSouthOffices-1.png",1,"I'm partial to that funny looking one in the back./");
