...
public class WarpShowStadium1toGiftShop extends Event {

	public static BufferedImage img=Assets.ClearDoor1;

	public static int stagenum = 1;
	public WarpShowStadium1toGiftShop(float x, float y, int idnum) {
	...
	public void run(){
		...
		case 1:
			...
			this.setstage(0);
			super.transport("/Worlds/Floor4Aquarium/AquariumBuilding/GiftShop1.txt",9,21,"");
			this.setOpen(false);
			this.setFrames(0);
			break;
		}
