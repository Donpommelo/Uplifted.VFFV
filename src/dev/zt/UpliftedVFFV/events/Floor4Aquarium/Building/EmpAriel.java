...
public class EmpAriel extends Event {
	...
	public void run(){
		...
		case 0: 
			...
			d[0] = new Dialog("Employee","/CharacterBusts/3rdSouthOffices-3.png",1,"Ah. The sound of flowing water is sure relaxing./");
			d[1] = new Dialog("Employee","/CharacterBusts/3rdSouthOffices-3.png",1,"Wait, why would there be flowing water in here . . . ?/");
