...
public class WarpLeftExhibitHalltoPettingZoo extends Event {

	public static BufferedImage img=Assets.ClearDoor1;

	public static int stagenum = 1;
	public WarpLeftExhibitHalltoPettingZoo(float x, float y, int idnum) {
	...
	public void run(){
		...
		case 1:
			...
			this.setstage(0);
			super.transport("/Worlds/Floor4Aquarium/AquariumBuilding/PettingZoo.txt",19,24,"");
			this.setOpen(false);
			this.setFrames(0);
			break;
		}
