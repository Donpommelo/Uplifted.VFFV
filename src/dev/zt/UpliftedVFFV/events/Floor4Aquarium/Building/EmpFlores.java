...
public class EmpFlores extends Event {
	...
	public void run(){
		...
		d[0] = new Dialog("Employee","/CharacterBusts/3rdSouthOffices-3.png",1,"These displays remind me of all the arts and crafts we made as children.");
