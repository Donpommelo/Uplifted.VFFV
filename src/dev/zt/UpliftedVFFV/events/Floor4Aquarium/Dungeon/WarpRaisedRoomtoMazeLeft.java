...
public class WarpRaisedRoomtoMazeLeft extends Event {

	public static BufferedImage img=Assets.ClearDoor1;

	public static int stagenum = 1;
	public WarpRaisedRoomtoMazeLeft(float x, float y, int idnum) {
	...
	public void run(){
		...
		case 1:
			...
			super.transport("/Worlds/Floor4Aquarium/WetworksDungeon/PipeMaze1.txt",4,65,"");
