...
public class WarpCentraltoDrainRoom extends Event {

	public static BufferedImage img=Assets.ClearDoor1;

	public static int stagenum = 1;
	public WarpCentraltoDrainRoom(float x, float y, int idnum) {
	...
	public void run(){
		...
		case 1:
			...
			super.transport("/Worlds/Floor4Aquarium/WetworksDungeon/DrainRoom.txt",10,14,"");
			this.setOpen(false);
			this.setFrames(0);
			break;
		}
