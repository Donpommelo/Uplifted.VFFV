...
public class WarpCentraltoBonusRoom extends Event {

	public static BufferedImage img=Assets.ClearDoor1;

	public static int stagenum = 1;
	public WarpCentraltoBonusRoom(float x, float y, int idnum) {
	...
	public void run(){
		...
		case 1:
			...
			super.transport("/Worlds/Floor4Aquarium/WetworksDungeon/BonusExtraRoom.txt",5,10,"");
			this.setOpen(false);
			this.setFrames(0);
			break;
		}
	...
	public void tick(GameState gs) {
		if(this.isOpen()){
			if(this.getFrames()<6){
				...
				if(KeyManager.isCutsceneMode() && gs.getPlayer().getPlayerX()== 384 && gs.getPlayer().getPlayerY()== 512){
