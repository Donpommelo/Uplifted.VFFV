...
public class EmpSandy extends Event {
	...
	public void run(){
		...
		d[0] = new Dialog("Employee","/CharacterBusts/3rdSouthOffices-3.png",1,"Its nice I guess, but its not really as awesome as Management made it sound.");
