...
public class EmpPearl extends Event {
	...
	public void run(){
		...
		d[0] = new Dialog("Employee","/CharacterBusts/3rdSouthOffices-3.png",1,"Goodness. It must have been a real hassle moving all this water to the 4th Floor.");
