...
public class WarpCentralLobbytoJCloset extends Event {

	public static BufferedImage img=Assets.PushDoor1;

	public static int stagenum = 1;
	public WarpCentralLobbytoJCloset(float x, float y, int idnum) {
	...
	public void run(){
		...
		case 1:
			...
			super.transport("/Worlds/Floor4Aquarium/AquariumTunnel/JanitorClosetTunnels.txt",5,10,"");
			this.setOpen(false);
			this.setFrames(0);
			break;
		}
