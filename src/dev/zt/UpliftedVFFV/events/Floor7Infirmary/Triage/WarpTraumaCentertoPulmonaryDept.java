...
public class WarpTraumaCentertoPulmonaryDept extends Event {

	public static BufferedImage img=Assets.ClearDoor1;

	public static int stagenum = 1;
	public WarpTraumaCentertoPulmonaryDept(float x, float y, int idnum) {
	...
	public void run(){
		...
		case 1:
			...
			this.setstage(0);
			super.transport("/Worlds/Floor7Infirmary/Triage/PulmonaryDept.txt",28,19,"Pulmonary Department");
			this.setOpen(false);
			this.setFrames(0);
			break;
		}
