...
public class WarpCentralChambertoPsycheAsylum extends Event {

	public static BufferedImage img=Assets.ClearDoor1;

	public static int stagenum = 1;
	public WarpCentralChambertoPsycheAsylum(float x, float y, int idnum) {
	...
	public void run(){
		...
		case 1:
			...
			this.setstage(0);
			super.transport("/Worlds/Floor7Infirmary/Triage/PsycheAsylum.txt",12,34,"Psyche Asylum");
			this.setOpen(false);
			this.setFrames(0);
			break;
		}
