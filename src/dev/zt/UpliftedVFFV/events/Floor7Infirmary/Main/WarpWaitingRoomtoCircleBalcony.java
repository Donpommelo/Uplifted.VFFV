...
public class WarpWaitingRoomtoCircleBalcony extends Event {

	public static BufferedImage img=Assets.ClearDoor1;

	public static int stagenum = 1;
	public WarpWaitingRoomtoCircleBalcony(float x, float y, int idnum) {
	...
	public void run(){
		...
		case 1:
			...
			this.setstage(0);
			super.transport("/Worlds/Floor7Infirmary/CircleBalcony.txt",17,35,"Infirmary");
			this.setOpen(false);
			this.setFrames(0);
			break;
		}
