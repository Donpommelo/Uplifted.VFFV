...
public class WarpImpalefiertoFacilityFloor1 extends Event {

	public static BufferedImage img=Assets.ClearDoor1;

	public static int stagenum = 1;
	public WarpImpalefiertoFacilityFloor1(float x, float y, int idnum) {
	...
	public void run(){
		...
		case 1:
			...
			this.setstage(0);
			super.transport("/Worlds/Floor7Infirmary/ResearchFacility/Floor1Main.txt",11,22,"");
			this.setOpen(false);
			this.setFrames(0);
			break;
		}
