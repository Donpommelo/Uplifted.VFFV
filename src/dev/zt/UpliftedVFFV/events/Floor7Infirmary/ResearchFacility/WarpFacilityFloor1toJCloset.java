...
public class WarpFacilityFloor1toJCloset extends Event {
	
	public static BufferedImage img=Assets.PushDoor1;
	public static int stagenum = 1;
	public WarpFacilityFloor1toJCloset(float x, float y, int idnum) {
	...
	public void run(){
		...
		case 1:
			...
			super.transport("/Worlds/Floor7Infirmary/ResearchFacility/JanitorClosetLab.txt", 5, 10,"Broom Closet");
			this.setOpen(false);
			this.setFrames(0);
			break;
		}
	...
	public void tick(GameState gs) {
		if(this.isOpen()){
			if(this.getFrames()<6){
				...
				if(KeyManager.isCutsceneMode() && gs.getPlayer().getPlayerX()== 352){
