...
public class WarpFacilityFloor1toCentrifuge extends Event {

	public static BufferedImage img=Assets.ClearDoor1;

	public static int stagenum = 1;
	public WarpFacilityFloor1toCentrifuge(float x, float y, int idnum) {
	...
	public void run(){
		...
		case 1:
			...
			this.setstage(0);
			super.transport("/Worlds/Floor7Infirmary/ResearchFacility/CentrifugeRoom.txt",6,12,"");
			this.setOpen(false);
			this.setFrames(0);
			break;
		}
