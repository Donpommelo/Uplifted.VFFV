...
public class WarpFacilityFloor1toExtractionator extends Event {

	public static BufferedImage img=Assets.ClearDoor1;

	public static int stagenum = 1;
	public WarpFacilityFloor1toExtractionator(float x, float y, int idnum) {
	...
	public void run(){
		...
		case 1:
			...
			this.setstage(0);
			super.transport("/Worlds/Floor7Infirmary/ResearchFacility/ExtractionatorRoom.txt",6,12,"");
			this.setOpen(false);
			this.setFrames(0);
			break;
		}
