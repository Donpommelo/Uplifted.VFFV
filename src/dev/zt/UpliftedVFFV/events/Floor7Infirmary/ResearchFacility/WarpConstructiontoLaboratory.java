...
public class WarpConstructiontoLaboratory extends Event {

	public static BufferedImage img=Assets.ClearDoor1;

	public static int stagenum = 1;
	public WarpConstructiontoLaboratory(float x, float y, int idnum) {
	...
	public void run(){
		...
		case 1:
			...
			this.setstage(0);
			super.transport("/Worlds/Floor7Infirmary/ResearchFacility/LaboratoryRoom.txt",19,30,"");
			this.setOpen(false);
			this.setFrames(0);
			break;
		}
