...
public class WarpEOPtoDissection extends Event {

	public static BufferedImage img=Assets.ClearDoor1;

	public static int stagenum = 1;
	public WarpEOPtoDissection(float x, float y, int idnum) {
	...
	public void run(){
		...
		case 1:
			...
			this.setstage(0);
			super.transport("/Worlds/Floor7Infirmary/ResearchFacility/DissectionRoom.txt",10,25,"Dissection Room");
			this.setOpen(false);
			this.setFrames(0);
			break;
		}
