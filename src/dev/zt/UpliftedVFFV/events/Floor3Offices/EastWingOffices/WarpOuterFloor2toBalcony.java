...
public class WarpOuterFloor2toBalcony extends Event {

	public static BufferedImage img=Assets.ClearDoor1;
	public static int stagenum = 1;
	public WarpOuterFloor2toBalcony(float x, float y, int idnum) {
	...
	public void run(){
		...
		case 1:
			...
			super.transport("/Worlds/Floor3Offices/EastWingOffices/EastOfficesLeftBalcony.txt",18,27,"");
			this.setOpen(false);
			this.setFrames(0);
			break;
		}
	...
	public void tick(GameState gs) {
		if(this.isOpen()){
			if(this.getFrames()<6){
				...
				if(KeyManager.isCutsceneMode() && (int)(gs.getPlayer().getPlayerX()) == 640){
