	...
	public void run(){
			if(this.isSelfswitch1()){
				...
				if(super.itemNumCheck(new ManilaFolder()) > 0 ){
					...
					d[2] = new Dialog("Carloc","/CharacterBusts/3rdEastOffices-5.png",1,"Now, for the next part of your little quest. I need you to deliver this package to my/coworker in the West Wing Offices./You can be certain that this quest will be well worth your time. Are we understood?/");
					d[3] = new Dialog("Carloc","/CharacterBusts/3rdEastOffices-5.png",1,"Run along now, but bear in mind that the West Wing is both tougher and more/productive than the other wings./");
					super.Dialog(d, 3, this.getId(), true);
					super.setQuest(5, 5);
					super.setQuest(3, 1);
