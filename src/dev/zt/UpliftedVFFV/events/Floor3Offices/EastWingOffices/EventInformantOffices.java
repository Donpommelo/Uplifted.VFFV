	...
	public void run(){
		...
		if(!this.isSelfswitch1()){
			...
			case 3:
				...
				d[8] = new Dialog("Informant","/CharacterBusts/Informant1small.png",1,"Here are the papers she is requesting. Complete whatever it is she demands. Just be quick about it. And try and find me afterwards so we can talk.");
				d[9] = new Dialog("Informant","/CharacterBusts/Informant1small.png",1,"There are some things you deserve to have explained to you . . .");
				d[10] = new Dialog("Informant","/CharacterBusts/Informant1small.png",1,"Let me open this door to the South for you. Oh, and tell Carloc not to send me any more.");
				d[11] = new Dialog("meep","/CharacterBusts/Arturo.png",1,"Obtained a Manila Folder!/Bring it back to Carloc in her office.");
