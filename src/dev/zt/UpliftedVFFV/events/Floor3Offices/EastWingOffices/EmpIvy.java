...
public class EmpIvy extends Event {
	...
	public void run(){
		...
		case 0: 
			...
			d[0] = new Dialog("Employee","/CharacterBusts/3rdEastOffices-3.png",1,"Oh yeah, they're definitely laughing at you./No doubt about it./");
