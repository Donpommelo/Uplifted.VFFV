...
public class EmpAbernathy extends Event {
	
	public static int stagenum = 1;
	public static BufferedImage img=SpriteSorter.SpriteSort(1,Assets.EmployeeM1);
	public EmpAbernathy(float x, float y, int idnum) {
	...
	public void run(){
		...
		case 0: 
			...
			d[0] = new Dialog("Employee","/CharacterBusts/3rdEastOffices-1.png",1,"It's nice to see that this company doesn't discriminate against the less-able.");
