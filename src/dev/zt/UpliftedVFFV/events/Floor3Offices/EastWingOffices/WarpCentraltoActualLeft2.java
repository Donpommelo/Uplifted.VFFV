...
public class WarpCentraltoActualLeft2 extends Event {
	
	public static BufferedImage img=Assets.ClearDoor1;
	public static int stagenum = 1;
	public WarpCentraltoActualLeft2(float x, float y, int idnum) {
	...
	public void run(){
		...
		case 1:
			...
			super.transport("/Worlds/Floor3Offices/EastWingOffices/ActualEastWing.txt",8,20,"");
