...
public class EmpNissa extends Event {
	...
	public void run(){
		...
		case 0: 
			...
			d[0] = new Dialog("Employee","/CharacterBusts/3rdEastOffices-3.png",1,"You sure look like you've had a rough morning./Maybe several consecutively./");
