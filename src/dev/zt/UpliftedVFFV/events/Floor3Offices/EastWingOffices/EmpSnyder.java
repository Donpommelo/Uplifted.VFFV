...
public class EmpSnyder extends Event {
	...
	public void run(){
		...
		case 0: 
			...
			d[0] = new Dialog("Employee","/CharacterBusts/3rdEastOffices-1.png",1,"What are you doing here?/Shouldn't you be staring at a wall in some elevator somewhere?");
