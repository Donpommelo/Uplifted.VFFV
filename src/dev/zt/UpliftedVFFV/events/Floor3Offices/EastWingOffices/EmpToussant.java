...
public class EmpToussant extends Event {
	
	public static int stagenum = 1;
	public static BufferedImage img=SpriteSorter.SpriteSort(1,Assets.EmployeeM1);
	public EmpToussant(float x, float y, int idnum) {
	...
	public void run(){
		...
		case 0: 
			...
			d[0] = new Dialog("Employee","/CharacterBusts/3rdEastOffices-1.png",1,"Y'know, it is possible to have no self confidence whatsoever and still be overconfident./");
