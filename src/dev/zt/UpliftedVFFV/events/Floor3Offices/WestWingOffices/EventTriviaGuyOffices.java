...
public class EventTriviaGuyOffices extends Event {
	...
	public void run(){
		...
		case 0: 
			if(!this.isSelfswitch1()){
				...
				d1[1] = new Dialog("Trivia Guy","/CharacterBusts/TriviaGuysmall.png",1,"Welcome, contestant, to game where every-day employees demonstrate mastery over their varied fields of study by answering devilishly difficult Trivia Questions!");
				d1[2] = new Dialog("Trivia Guy","/CharacterBusts/TriviaGuysmall.png",1,"Being the Operator of this company, expect to have your elevator-related knowledge tested! Answer the following question correctly and receive a fabulous prize!");
				d1[3] = new Dialog("Trivia Guy","/CharacterBusts/TriviaGuysmall.png",1,"Answer incorrectly, and bring great embarrassment to yourself and your coworkers!");
				d1[4] = new Dialog("Trivia Guy","/CharacterBusts/TriviaGuysmall.png",1,"Ready? No cheating!");
	...
	public void ChoiceMade(int i){
		if(i == 1){
			...
			d1[2] = new Dialog("Trivia Guy","/CharacterBusts/TriviaGuysmall.png",1,"The Car Apron, also known as the Toe Guard serves as an extra line of defense against the dangers of an open elevator shaft!");
			d1[3] = new Dialog("Trivia Guy","/CharacterBusts/TriviaGuysmall.png",1,"You can never be too careful, really when it comes to the lives of fellow coworkers!");
			d1[4] = new Dialog("Trivia Guy","/CharacterBusts/TriviaGuysmall.png",1,"Such knowledge! I expected no less from our building's one and only elevator Operator!/Oh, and as for your reward . . .");
			d1[5] = new Dialog("meep","/CharacterBusts/Arturo.png",1,"You Obtained the Trivia Trinket!");
			super.Dialog(d1, 5, this.getId(), true);
			//Get Reward Item
		}
		else{
