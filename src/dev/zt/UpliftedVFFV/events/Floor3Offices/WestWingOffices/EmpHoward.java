...
public class EmpHoward extends Event {
	...
	public void run(){
		...
		case 0: 
			...
			d[0] = new Dialog("Employee","/CharacterBusts/3rdWestOffices-1.png",1,"I used to have dreams./But even in my sleep there was work that needed to be done./");
