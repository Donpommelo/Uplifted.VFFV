...
public class WarpWestPredungeontoCubicleDungeon extends Event {

	public static BufferedImage img=Assets.ClearDoor1;
	public static int stagenum = 1;
	public WarpWestPredungeontoCubicleDungeon(float x, float y, int idnum) {
	...
	public void tick(GameState gs) {
		if(this.isOpen()){
			if(this.getFrames()<6){
				...
				if(KeyManager.isCutsceneMode() && (int)(gs.getPlayer().getPlayerX()) == 320){
