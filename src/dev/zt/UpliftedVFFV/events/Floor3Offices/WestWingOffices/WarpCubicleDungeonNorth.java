...
public class WarpCubicleDungeonNorth extends Event {

	public static BufferedImage img=Assets.ClearDoor1;
	public static int stagenum = 1;
	public WarpCubicleDungeonNorth(float x, float y, int idnum) {
	...
	public void run(){
		...
		case 1:
			...
			if(!super.getSwitch(26)){
				...
				super.transport("/Worlds/Floor3Offices/WestWingOffices/WestBonusRoom1.txt",6,12,"");
			}
			this.setOpen(false);
			this.setFrames(0);
			break;
