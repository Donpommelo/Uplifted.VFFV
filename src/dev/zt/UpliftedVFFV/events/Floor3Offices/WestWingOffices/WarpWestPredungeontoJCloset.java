...
public class WarpWestPredungeontoJCloset extends Event {
	
	public static BufferedImage img=Assets.PushDoor1;
	public static int stagenum = 1;
	public WarpWestPredungeontoJCloset(float x, float y, int idnum) {
	...
	public void run(){
		...
		case 1:
			...
			super.transport("/Worlds/Floor3Offices/WestWingOffices/JanitorClosetWest.txt", 5, 10,"Broom Closet");
			this.setOpen(false);
			this.setFrames(0);
			break;
		}
