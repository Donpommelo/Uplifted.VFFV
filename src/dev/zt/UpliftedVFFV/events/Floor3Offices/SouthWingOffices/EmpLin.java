	...
	public void run(){
		...
		case 0: 
			if(this.isSelfswitch2()){
				...
				d[2] = new Dialog("Employee","/CharacterBusts/3rdWestOffices-3.png",1,"It's top secret. If you don't already know, I can't tell you. So definitely don't bother asking me again. For sure.");
				...
				d[12] = new Dialog("Employee","/CharacterBusts/3rdWestOffices-3.png",1,"Hmm. It makes sense to me. We couldn't have a department of Happiness because Happiness is a nice thing that the whole company should experience, not just one department.");
