	...
	public void run(){
			...
			case 0: 
				if(!isSelfswitch1()){
					...
					d[2] = new Dialog("Jorge","/CharacterBusts/3rdSouthOffices-5.png",0,"Harghmph. You came to waste my time with that? Who do you think you are?");
					d[3] = new Dialog("Jorge","/CharacterBusts/3rdSouthOffices-5.png",0,"Of course I know where it is. Suite Five-hundred and twenty Whatever, I know all about it. Hehehe. But I don't feel like telling you.");
					d[4] = new Dialog("Jorge","/CharacterBusts/3rdSouthOffices-5.png",0,"Yeah, If you lack the manners to not bother me and the common sense to find the damn room yourself, why should I help you?");
					d[5] = new Dialog("Operator","/CharacterBusts/Player-1.png",0,"That seems. . .  unprofessional. . .");
