...
public class EmpAnderson extends Event {
	
	public static int stagenum = 1;
	public static BufferedImage img=SpriteSorter.SpriteSort(10,Assets.EmployeeM1);
	public EmpAnderson(float x, float y, int idnum) {
	...
	public void run(){
		...
		case 0: 
			...
			d[0] = new Dialog("Employee","/CharacterBusts/3rdWestOffices-1.png",1,"Collaborating with South Office on this initiative was a mistake. This has not been a productive session.");
