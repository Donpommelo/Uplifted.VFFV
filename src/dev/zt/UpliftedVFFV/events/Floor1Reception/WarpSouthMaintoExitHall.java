...
public class WarpSouthMaintoExitHall extends Event {

	public static BufferedImage img=Assets.PushDoor1;
	public static int stagenum = 1;
	public WarpSouthMaintoExitHall(float x, float y, int idnum) {
	...
	public void run(){
		...
		case 1:
			...
			this.setstage(0);
			super.transport("/Worlds/Floor1Reception/SouthLobbyExitHall.txt",8,12,"");
			this.setOpen(false);
			this.setFrames(0);
			break;
		}
