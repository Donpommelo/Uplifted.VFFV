...
public class EventVermillionGate extends Event {
	...
	public EventVermillionGate(float x, float y, int idnum) {
		...
		case 0:
			if(this.isSelfswitch1()){
				...
				if(balls.size() < 1){					
					...
					d[0] = new Dialog("meep","/CharacterBusts/Arturo.png",1,"A mysterious Vermillion arch with a ball-shaped receptacle.");
					...
					d1[0] = new Dialog("meep","/CharacterBusts/Arturo.png",1,"A mysterious Vermillion arch with a ball-shaped receptacle.");
