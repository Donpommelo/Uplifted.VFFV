...
public class EventChartreuseGate extends Event {
	...
	public EventChartreuseGate(float x, float y, int idnum) {
	...
	public void run(){
		...
		case 0:
			if(this.isSelfswitch1()){
				super.transport("/Worlds/Floor6FoodServery/LachiplatreLand/ExtraRoom1.txt",6,10,"");
				this.setstage(0);
			}
			else{
				if(balls.size() < 1){					
					Dialog[] d = new Dialog[2];
					d[0] = new Dialog("meep","/CharacterBusts/Arturo.png",1,"A mysterious Chartreuse arch with a ball-shaped receptacle.");
					...
					d1[0] = new Dialog("meep","/CharacterBusts/Arturo.png",1,"A mysterious Chartreuse arch with a ball-shaped receptacle.");
