...
public class WarpFoodCourtLobbytoEatery extends Event {

	public static BufferedImage img=Assets.ClearDoor1;

	public static int stagenum = 1;
	public WarpFoodCourtLobbytoEatery(float x, float y, int idnum) {
	...
	public void run(){
		...
		case 1:
			...
			this.setstage(0);
			super.transport("/Worlds/Floor6FoodServery/FoodCourt/Eatery.txt",33,65,"");
			this.setOpen(false);
			this.setFrames(0);
			break;
		}
