...
public class WarpIntroHalltoHarvesting extends Event {

	public static BufferedImage img=Assets.ClearDoor1;

	public static int stagenum = 1;
	public WarpIntroHalltoHarvesting(float x, float y, int idnum) {
	...
	public void run(){
		if(super.getQuest(13) >1){
			...
			case 1:
				...
				this.setstage(0);
				super.transport("/Worlds/Floor6FoodServery/Processing/Harvesting.txt",13,47,"Harvesting");
				this.setOpen(false);
				this.setFrames(0);
				break;
			}
