...
public class WarpProcessing2toFreezer extends Event {

	public static BufferedImage img=Assets.ClearDoor1;

	public static int stagenum = 1;
	public WarpProcessing2toFreezer(float x, float y, int idnum) {
	...
	public void run(){
		...
		case 1:
			...
			this.setstage(0);
			super.transport("/Worlds/Floor6FoodServery/Processing/FreezerRoom.txt",(int)(gamestate.getPlayer().getPlayerX()/32),22,"Freezer");
			this.setOpen(false);
			this.setFrames(0);
			break;
		}
