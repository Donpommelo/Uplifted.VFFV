...
public class WarpEmulsifyingtoLifeSpring extends Event {

	public static BufferedImage img=Assets.ClearDoor1;

	public static int stagenum = 1;
	public WarpEmulsifyingtoLifeSpring(float x, float y, int idnum) {
	...
	public void run(){
		...
		case 1:
			...
			this.setstage(0);
			super.transport("/Worlds/Floor6FoodServery/Processing/LifeSpring.txt",8,14,"? ? ?");
			this.setOpen(false);
			this.setFrames(0);
			break;
		}
