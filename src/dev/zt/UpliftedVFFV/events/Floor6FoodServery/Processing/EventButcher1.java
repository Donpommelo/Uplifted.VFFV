...
public class EventButcher1 extends Event {

	public String[] Choices={"Nothing","Bacon","Bologna","Bratwurst","Churrasco","Corned Beef","Ham","Hamburger Patty","Lamb","Mortadella","Pastrami","Proscuitto","Pulled Pork","Roast Beef","Salami","Venison"};			//list of choices used in the choicebranch
	public static int stagenum = 1;

	public Item bottle;
	public static BufferedImage img=Assets.Monolith;
	public EventButcher1(float x, float y, int idnum) {
