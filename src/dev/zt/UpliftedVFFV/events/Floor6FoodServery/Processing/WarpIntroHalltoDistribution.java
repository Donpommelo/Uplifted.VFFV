...
public class WarpIntroHalltoDistribution extends Event {

	public static BufferedImage img=Assets.ClearDoor1;

	public static int stagenum = 1;
	public WarpIntroHalltoDistribution(float x, float y, int idnum) {
		super(img,idnum,x, y, stagenum);
	}	

	
	public void run(){
		if(super.getQuest(13) > 3){
			...
			case 1:
				...
				this.setstage(0);
				super.transport("/Worlds/Floor6FoodServery/Processing/Distribution.txt",27,16,"Distribution");
				this.setOpen(false);
				this.setFrames(0);
				break;
			}
