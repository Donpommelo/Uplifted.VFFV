...
public class EventFisher1 extends Event {

	public String[] Choices={"Nothing","Anchovy Paste","Breaded Cod","Caviar","Cuttlefish","Grilled Eel","Herring","Lobster","Mackerel","Shrimp","Smoked Salmon","Tuna"};			//list of choices used in the choicebranch
	public static int stagenum = 1;

	public Item bottle;
	public static BufferedImage img=Assets.Monolith;
	public EventFisher1(float x, float y, int idnum) {
	...
	public void run(){
		...
		case 0:
			if(this.isSelfswitch1()){
				...
				d1[0] = new Dialog("Fisher","/CharacterBusts/ServeryMRedsmall.png",1,"");
				d1[1] = new Dialog("Fisher","/CharacterBusts/ServeryMRedsmall.png",1,"What do you need?");
				...
				d1[0] = new Dialog("Fisher","/CharacterBusts/ServeryMRedsmall.png",1,"Oh, its you again.");
				super.Dialog(d1, 2, this.getId(), true);
			}
