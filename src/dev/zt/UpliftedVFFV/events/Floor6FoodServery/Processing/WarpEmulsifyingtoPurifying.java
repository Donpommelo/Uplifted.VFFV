...
public class WarpEmulsifyingtoPurifying extends Event {

	public static BufferedImage img=Assets.ClearDoor1;

	public static int stagenum = 1;
	public WarpEmulsifyingtoPurifying(float x, float y, int idnum) {
	...
	public void run(){
		...
		case 1:
			...
			this.setstage(0);
			super.transport("/Worlds/Floor6FoodServery/Processing/PurifyingRoom.txt",11,20,"Purification Room");
			this.setOpen(false);
			this.setFrames(0);
			break;
		}
