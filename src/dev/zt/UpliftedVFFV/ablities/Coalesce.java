...
public class Coalesce extends Skills {
	...
	public void run(Schmuck perp, Schmuck vic, BattleState bs){	
		for(int i = 0; i < 2; i++){
			...
			switch(random){
			case 0:
				bs.bp.stm.addStatus(perp, new StatBuffMult(4,2,1.1, perp,50));
				break;
			case 1:
				bs.bp.stm.addStatus(perp, new StatBuffMult(4,3,1.1, perp,50));
				break;
			case 2:
				bs.bp.stm.addStatus(perp, new StatBuffMult(4,4,1.1, perp,50));
				break;
			case 3:
				bs.bp.stm.addStatus(perp, new StatBuffMult(4,5,1.1, perp,50));
				break;
			case 4:
				bs.bp.stm.addStatus(perp, new StatBuffMult(4,6,1.1, perp,50));
				break;
			case 5:
				bs.bp.stm.addStatus(perp, new StatBuffMult(4,7,1.1, perp,50));
				break;
			}
		}
	}
