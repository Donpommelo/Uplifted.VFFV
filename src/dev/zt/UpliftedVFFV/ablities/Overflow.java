...
public class Overflow extends Skills {

	public static String name = "Overflow";
	public static String descr = "TEMP";
	public static String descrShort = "Deals Blue damage to all other characters";
	public static int cost = 25;
	public static int baseAcc = 100; public static int baseCrit = 0;
	public static boolean canMiss = false; public static boolean canCrit = true;
	public static int element = 1;	//Blue
	public static int targetType = 1;	//No Target
	public Overflow(int index) {
		...
		for(Schmuck s : bs.bp.battlers){
			if(!bs.bp.stm.checkStatus(s, new incapacitate(s,s))){
				if(s != perp){
					...
					bs.bp.em.hpChange(damage, perp, s,1);
				}
			}
		}
	}
